...
class CardInstanceService(BaseService[CardInstance]):
    ...
    async def create_owned(
        ...
        """Add an owned card to the user's wallet. Acquisition is encoded
        by date columns — opening_date is the only thing the user provides
        beyond the library card_id."""
