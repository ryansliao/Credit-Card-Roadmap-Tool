...
Spend lives on the wallet (one set per user, no scenario variation). The
singular ``/wallet/spend-items`` endpoints are the canonical path; the
legacy ``/wallets/{wallet_id}/spend-items`` family is preserved during the
migration window.
"""
...
# ---------------------------------------------------------------------------
# Legacy wallet-id-scoped endpoints (deprecated; migration window)
# ---------------------------------------------------------------------------
